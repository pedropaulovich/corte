...
Abra `Calculadora de Corte de Mangas.html` no navegador (funciona offline, sem instalar nada — inclusive no Chrome do celular).
...
- `Calculadora de Corte de Mangas.html` — a calculadora (arquivo único, sem dependências externas)
